...
import com.example.vamsi.blogpost.chat.ChatsActivity;
import com.example.vamsi.blogpost.chat.Group;
import com.example.vamsi.blogpost.chat.GroupListAdapter;

import java.util.List;

import de.hdodenhof.circleimageview.CircleImageView;

public class UsersGroupListAdapter extends RecyclerView.Adapter<UsersGroupListAdapter.ViewHolder> {
    private Context context;
    private List<Group> mData;
    private LayoutInflater mInflater;
    // data is passed into the constructor
    public UsersGroupListAdapter(List<Group> data,Context context) {
        this.context=context;
        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
    }

    public UsersGroupListAdapter()
    {}
    ...
    @Override
    public void onBindViewHolder(UsersGroupListAdapter.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("parent","AddGroupActivity");
